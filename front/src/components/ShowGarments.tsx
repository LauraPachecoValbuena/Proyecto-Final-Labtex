      ...
      <div className="row" id="rowGarments">
        {props.garments
          ...
          .map(g => (
            ...
            <div
              key={g._id}
              className="col-sm-3 card border-light mb-3 btn-outline-info"
            >
              {g.images && (
                <img
              ...
              <div className="card-body">
                <div>
                  ...
                  <div className="card-text">{g.description}</div>
                </div>
        ...
        {(props.myUser.role === "5d3ebb9c17fb7b60d454b0a8" ||
          ...
          <div className="container">
            <div className="row">
              <div className="col-12 col-12AddGarment">
                <Link
                  to={
                    "/seasons/" + props.match.params.season_id + "/garments/add"
                  }
